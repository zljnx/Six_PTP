...
<head>
    ...
    <meta name="description" content="黄金杯网贷最新理财产品介绍：p2p投资理财,投资理财产品,投资理财项目,黄金杯网贷-你的投资理财得力助手,助你投资理财发大财。"/>
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE8"/>
    <meta http-equiv="Pragma" CONTENT="no-cache"/>
    <meta http-equiv="Cache-Control" CONTENT="no-cache"/>
    <meta http-equiv="Expires" CONTENT="0"/>
    <title>p2p投资理财_投资理财产品_投资理财项目-黄金杯网贷理财产品介绍
    </title>
...
<body>
<div style="position:fixed; background:#fff; z-index:9999;width:100%;height:40px; overflow:hidden; display:block;" id='b32b28c4-496e-49f6-bceb-bc48703129d7'>
    <div style='padding-left:28%;color: #c30;font-size:18px;'>
        警告: 如果看到该信息,可能是因为您的浏览器没有启用JavaScript功能，请开启该功能并在重启后访问网站。
    </div>
</div>
<script type="text/javascript">try{document.getElementById('b32b28c4-496e-49f6-bceb-bc48703129d7').style.display='none';}catch(e){}</script>
...
<div class="main_bg">
    <div class="main_mod">
        <div class="main_hd"><i class="icon"></i><span
                class="gray3 f18">黄金杯网贷理财-产品介绍</span></div>
                    ...
                    <div class="content clearfix">
                        ...
                        <div class="mo_right">
                            <div class="info">
                                ...
                                <div class="info">
                                    <div class="til01">平台提供信用认证标、机构担保标、实地认证标等多类产品，用户根据审核后的信息，自选合适的借款标的，构建符合个人意愿的投资组合。</div>
                                    <ul class="introduce clearfix">
                                        <li>• 标的年利率区间1%-24%</li>
                                        <li>• 投资标的适用本金保障计划</li>
                                        <li>• 期限灵活，3-36个月</li>
                                        <li>• 债权持有90天以上，可进行转让</li>
                                    </ul>
                                </div></div>
                            <div class="immediate">
                                <div class="con">
                                    <a href="http://112.95.233.249:8503/credit/lcjsq.html"
                    ...
                    <div class="content clearfix">
                        ...
                        <div class="mo_right">
                            <div class="info">
                                <div class="til01">平台提供信用认证标、机构担保标、实地认证标等多类产品，用户根据审核后的信息，自选合适的借款标的，构建符合个人意愿的投资组合。</div>
                                <ul class="introduce clearfix">
                                    <li>• 提供转让功能，增加资金流动性</li>
                                    <li>• 债权持有90天后即可进行转让</li>
                                    <li>• 债权转让次数不限</li>
                                    <li>• 寻找折价债权，获得更多折让收益</li>
                                    <li>• 无投资门槛</li>
                                </ul>
