...
<div class="layui-col-md12">
    <div class="layui-card">
        <div class="layui-card-header">个人借款意向管理</div>
            ...
            <form class="layui-form" id="" method="post" style="display:inline">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="tel" id="username" name="username" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline" >
                            <input type="text" id="grsubmittime" name="grsubmittime" class="layui-input test-item"  placeholder="年-月-日" readonly>
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" >
                            <input type="text" id="handlingtime" name="handlingtime" class="layui-input test-item"  placeholder="年-月-日" readonly>
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">状态</label>
                        <div class="layui-input-inline">
                            <select id="grjkstatus" name="grjkstatus" >
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <a class="layui-btn search_btn" data-type="reload" id="geren">搜索</a>
                            <button type="reset" class="layui-btn layui-btn-primary" >重置</button>
                        </div>
                        <a  class="layui-btn search_btn" id="daochu">导出</a>
                    </div>
                </div>
            </form>
        </div>
...
<table class="layui-hide" id="gerenjiekuan" lay-filter="demo" ></table>
...
<script type="application/javascript">
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table','form','element'], function(){
        ...
        var tableIns =  table.render({
            elem: '#gerenjiekuan'
            ,method: 'post'
            ,url: '<%=request.getContextPath()%>/borrowmoney/queryPersonalloanintentionList.do' //数据接口
            ,page: true //开启分页
            ,limit:5
            ,limits:[5,10,15,20]
            ,id: 'geren'
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'grjkstatus', title: '状态', width:60,
                    templet: function(d) {
                        if(d.grjkstatus == 1){
                            return "未处理";
                        }
        ...
        $("#geren").on("click", function() {
            tableIns.reload({
                ...
                where: {
                    ...
                    grsubmittime: $("#grsubmittime").val(),
                    handlingtime: $("#handlingtime").val(),
                    grjkstatus: $("#grjkstatus").val()
                }
            });
        });
        ...
        table.on('tool(demo)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'chuli'){
                layer.msg('ID：'+ data.grjkid + ' 的查看操作');
                layer.prompt({
                    formType: 2,
                ...
                layer.open({
                    ...
                    type: 2,
                    area: ['500px', '560px'],
                    content: "<%=request.getContextPath()%>/borrowmoney/gerenxiangqing.do?grjkid="+data.grjkid //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                });
              //location.href="<%=request.getContextPath()%>/borrowmoney/gerenxiangqing.do?grjkid="+data.grjkid;
                //$.post("<%=request.getContextPath()%>/borrowmoney/gerenxiangqing.do?grjkid="+data.grjkid);
            }
        });

        $("#daochu").on("click", function() {
            location.href="<%=request.getContextPath()%>/borrowmoney/daochu.do"
        })
