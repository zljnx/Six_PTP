                ...
                <div class="border mt20">
                    <div class="tabnav-container">
                        <ul class="clearfix">
                            ...
                            <li><a href="javascript:void(0);" class="tab-btn select-a">垫付记录<i
                                ...
                                <div class="table-container">
                                    <table border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ${lxgInstitutionCombination.loginname}
                                            </td>
                                            <td>
                                                ${lxgInstitutionCombination.borrowing_title}
                                            </td>
                                            <td>
                                                ${lxgInstitutionCombination.payment_amount}
                                            </td>
                                            <td>
                                                ${lxgInstitutionCombination.pay_back_amount}
                                            </td>
                                            <td>
                                                ${lxgInstitutionCombination.overdue_periods}
                                            </td>
                                            <td>
