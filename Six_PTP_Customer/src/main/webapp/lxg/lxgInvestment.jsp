                ...
                <div class="border mt20">
                    <div class="tabnav-container">
                        <ul class="clearfix">
                            ...
                            <li>
                                <a href="/lxg/lxgDistressed.jsp?id=199&operationJK=null"
                                   class="tab-btn ">不良债权购买记录</a></li>
                                ...
                                <div class="table-container">
                                    <table border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ${lxgInstitutionCombination.time_limit}
                                            </td>
                                            <td>
                                                <fmt:formatDate value="${lxgInstitutionCombination.investment_time}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                            </td>
                                            <td>
