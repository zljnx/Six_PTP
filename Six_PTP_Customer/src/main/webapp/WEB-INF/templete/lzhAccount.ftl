...
<div class="main_bg clearfix">
    <div class="user_wrap w1002 clearfix">
        ...
        <div class="w200">
                ...
                <div class="portrait">
                    <a href="#">
                        <#list  list as  userInfo>
                            <img src='${userInfo.filename}' id="img"/>
                        </#list>
                    </a>
                </div>
            ...
            <div class="sidemenu">
                <div class="my_account"><a href="lzhAccount.html"><i class="icon"></i>我的账户</a></div>
                <ul class="menu">
                    <li class="group">
                ...
                <div class="clearfix">
                    <div class="info_l">
                        ...
                        <script type="text/javascript">
                            ...
                            $.ajax({
                                url : "/lzhUserInfo/queryTreportforms.do?id="+1,
                                type : "post",
                                dataType: "json",
